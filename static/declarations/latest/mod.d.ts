 ...
 *      Fae.head(''); //=> ''
 */
export declare const head: (<F extends string | ArrayLike<any> | Iterable<any> | Iterator<any, any, undefined>>(functor: F) => F extends import("./utils/types").FunctorWithArLk<infer U> ? U : string) & ((functor?: typeof import("./mod")._) => (<F extends string | ArrayLike<any> | Iterable<any> | Iterator<any, any, undefined>>(functor: F) => F extends import("./utils/types").FunctorWithArLk<infer U> ? U : string) & any);
...
export declare type Nth_2 = (<F extends FunctorWithArLk<any> | string>(functor: F) => NthReturnType<F>) & ((functor?: PH) => Nth_2);
export declare type Nth_1<F extends FunctorWithArLk<any> | string> = ((index: number) => NthReturnType<F>) & ((index?: PH) => Nth_1<F>);
export declare type Nth = (<F extends FunctorWithArLk<any> | string>(index: number, functor: F) => NthReturnType<F>) & ((index: number, functor?: PH) => Nth_2) & (<F extends FunctorWithArLk<any> | string>(index: PH, functor: F) => Nth_1<F>) & ((index?: PH, functor?: PH) => Nth);
/**
